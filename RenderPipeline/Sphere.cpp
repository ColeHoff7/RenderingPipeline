...
void Sphere::initialize()
{
	...
	// Create the bufferload data into it.
	glGenBuffers(1, &VBO);
...
void Sphere::initializeSphereBody()
{
	...
	for (int i = 1; i < stacks - 1; i++)
	{
		...
		// Again, Set up all slices for sphere body, using formula for points from center of a sphere
...
void Sphere::initializeSphereBottom()
{
	...
	// Again going through all slices, for sphere bottom now, using formula for points on a sphere
	for (int j = 0; j < slices; j++) {
